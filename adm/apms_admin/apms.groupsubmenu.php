...
<div id="menu-wrapper">
	<div class="local_desc01 local_desc">
		<b>● "<?php echo $group['gr_subject'];?> > <?php echo $row1['bo_subject'];?>"</b> 서브메뉴 설정
	</div>
	...
	<div class="btn_confirm01 btn_confirm" style="text-align:center;">
		...
		<a href="./apms.groupsubmenu.php?gr_id=<?php echo $gr_id;?>&amp;cid=<?php echo $cid;?>&amp;mode=menu&amp;opt=add" class="btn btn_03 apms-confirm">
			일반메뉴추가
		</a>
