...
$img_post_cnt = (isset($wset['irows']) && $wset['irows'] > 0) ? $wset['irows'] : 2;
if($img_post_cnt > 4) {
	$img_post_cnt = 2;
}
...
switch($img_post_cnt) {
	...
	case '3'	: $is_dadan = ' is-3'; break;
	case '4'	: $is_dadan = ' is-2'; break;
	default		: $is_dadan = ''; break;
}
...
// 스타일
$is_fix = (isset($wset['fix']) && $wset['fix']) ? '' : ' is-fix'; 
...
?>
<div class="media brex-post-sero<?php echo (isset($wset['fix']) && $wset['fix']) ? '' : ' is-fix';?>">
	<div class="post-align pull-<?php echo (isset($wset['right']) && $wset['right']) ? 'right' : 'left';?>" style="width:<?php echo (isset($wset['size']) && $wset['size'] > 0) ? $wset['size'] : 125;?>px;">
