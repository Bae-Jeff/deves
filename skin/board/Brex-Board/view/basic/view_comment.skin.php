...
<!--div class="view-comment font-24 en">
	<b><span class="orangered"><?php echo number_format($write['wr_comment']);?></span><span class="font-13">개의 댓글</span></b>
</div-->
				...
				<div class="media-body">
					...
					<div class="media-content">
						...
						<?php echo $comment ?>
							...
							<?php } ?>
						<?php if($list[$i]['wr_10'] == 'm') {?>
							<div class="text-muted font-11"><i class="fa fa-tablet"></i> 모바일에서 작성된 댓글입니다.</div>
						<?php } ?>
					</div>
			  </div>
			</div>
...
<aside id="bo_vc_w">
		...
		<?php echo (G5_IS_MOBILE) ? '<input type="hidden" name="wr_10" value="m">' : ''; ?>
		...
		<div class="comment-box">
			...
			<div class="form-group comment-content">
				<div class="comment-cell">
					<textarea tabindex="13" id="wr_content" name="wr_content" maxlength="10000" rows=2 class="form-control input-sm" title="내용"
...
<?php } else { ?>
	<div class="h10"></div>
	<div class="text-center help-guest">
		<?php if($is_guest) { ?>
