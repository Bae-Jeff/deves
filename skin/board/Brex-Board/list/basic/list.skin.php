...
if(isset($boset['hskin']) && $boset['hskin']) {
	...
	$head_class = (isset($boset['hcolor']) && $boset['hcolor']) ? 'border-'.$boset['hcolor'] : 'border-lightgray';
}
...
<div class="list-board">
	<div class="div-head hidden-xs <?php echo $head_class;?>">
		<?php if ($is_checkbox) { ?>
	...
	?>
		<li class="list-item<?php echo $li_css;?><?php echo ($i > 0 && $i%2 == 1) ? ' odd-li' : '';?>">
			<?php if ($is_checkbox) { ?>
				<div class="wr-chk">
				...
				<a href="<?php echo $list[$i]['href']; ?>" class="item-subject"<?php echo $list[$i]['target'];?><?php echo $is_modal_js;?>>
					<?php if ($list[$i]['wr_comment']) { ?>
						<span class="orangered visible-xs pull-right wr-comment">
							<b class="orangered">[<?php echo $list[$i]['wr_comment']; ?>]</b>
						</span>
					<?php } ?>
