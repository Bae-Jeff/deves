...
?>
<style>
.list-wrap .pagination .active a, .view-wrap .pagination .active a { background:#<?php echo $brex_color;?> !important; border-color:#<?php echo $brex_color;?> !important; }
</style>
			...
			<div class="list-btn">
				<div class="form-group pull-right">
					<div class="btn-group dropup" role="group">
						...
						<?php if ($list_href) { ?><a role="button" href="<?php echo $list_href ?>" class="btn btn-<?php echo $btn1;?> btn-sm">목록</a><?php } ?>
