	...
	<div class="row">
		...
		<div class="col-sm-6">
			...
			<?php if ($itemVersion['item_use_days']) { ?>
				<tr><th scope="row">사용기간</th><td><?php echo $itemVersion['item_use_days']; // ?></td></tr>
			<?php } ?>
			<?php if ($itemVersion['item_download_days']) { ?>
				<tr><th scope="row">다운로드 기간</th><td><?php echo $itemVersion['item_download_days']; // ?></td></tr>
			<?php } ?>
