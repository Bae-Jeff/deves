...
// 데모일 때 설정
$demo_config = array('bo_table' => 'free', 'ca_id' => '10', 'ev_id' => '', 'bn_id' => '');
...
$search_skin_path   = G5_SKIN_PATH.'/search/Brex-PGSP';
$search_skin_url    = G5_SKIN_URL.'/search/Brex-PGSP';
...
if($bo_table == 'free') {
	$board['bo_'.MOBILE_.'skin'] = 'Brex-Board';
