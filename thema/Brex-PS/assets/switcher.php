			...
			<div class="switcher-content">
				...
				<div class="panel-group" id="switcherSet" role="tablist" aria-multiselectable="true">
					...
					<div class="panel">
						...
						<div id="swSet<?php echo $toggle;?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="swHead<?php echo $toggle;?>">
							<div class="panel-body">
								...
								<div class="input-group input-group-sm input-bottom">
									<span class="input-group-addon">서브폭</span>
									<input type="text" class="form-control input-sm" name="at_set[page_size]" value="<?php echo $at_set['page_size'];?>" placeholder="1200">
									<span class="input-group-addon">px</span>
								</div>

								<div class="input-group input-group-sm input-bottom">
									<span class="input-group-addon">검색폭</span>
									<input type="text" class="form-control input-sm" name="at_set[s_size]" value="<?php echo $at_set['s_size'];?>" placeholder="1200">
									<span class="input-group-addon">px</span>
								</div>
							...
							<div class="panel-body">
								...
								<div class="input-group input-group-sm input-bottom">
									...
									<select id="nav-style" name="at_set[nav]" class="form-control">
										<option value="float">좌측</option>
										<option value="both"<?php echo get_selected('both', $at_set['nav']);?>>배분</option>
									</select>
								</div>
								...
								<div class="input-group input-group-sm input-bottom">
									...
									<select name="at_set[subv]" class="form-control">
										...
										<option value="slide"<?php echo get_selected('slide', $at_set['subv']);?>>슬라이드</option>
								...
								<div class="input-group input-group-sm input-bottom">
									<span class="input-group-addon">메뉴높이(S)</span>
									<input type="text" class="form-control input-sm" name="at_set[smh]" value="<?php echo $at_set['smh'];?>" placeholder="44">
									<span class="input-group-addon">px</span>
								</div>

								<div class="input-group input-group-sm input-bottom">
									<span class="input-group-addon">메뉴간격(S)</span>
									<input type="text" class="form-control input-sm" name="at_set[sms]" value="<?php echo $at_set['sms'];?>" placeholder="25">
									<span class="input-group-addon">px</span>
								</div>
							...
							<div class="panel-body">
								...
								<div class="input-group input-group-sm input-bottom">
									...
									<select id="page-style" name="at_set[page]" class="form-control input-sm">
										<option value="8">2단 - 미디움</option>
										<option value="9"<?php echo get_selected('9', $at_set['page']);?>>2단 - 라지</option>
					...
					<div class="panel">
						<div class="panel-heading" role="tab" id="swHead<?php $toggle++; echo $toggle;?>" aria-expanded="true" aria-controls="swSet<?php echo $toggle;?>">
							<a data-toggle="collapse" data-parent="#switcherSet" href="#swSet<?php echo $toggle;?>">
								<i class="fa fa-caret-right"></i> 에드온 설정
							</a>
						</div>
						<div id="swSet<?php echo $toggle;?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="swHead<?php echo $toggle;?>">
							<div class="panel-body">
								<div class="input-group input-group-sm input-bottom">
									<span class="input-group-addon">알림(서브)</span>
									<select id="page-style" name="at_set[add]" class="form-control input-sm">
										<option value="a1">사용</option>
										<option value="a2"<?php echo get_selected('a2', $at_set['add']);?>>미사용</option>
									</select>
								</div>

								<div class="input-group input-group-sm input-bottom">
									<span class="input-group-addon">알림(검색)</span>
									<select id="page-style" name="at_set[sadd]" class="form-control input-sm">
										<option value="b1">사용</option>
										<option value="b2"<?php echo get_selected('b2', $at_set['sadd']);?>>미사용</option>
									</select>
								</div>
