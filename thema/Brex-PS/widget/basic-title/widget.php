...
<style>
	...
	.title-layer { position:absolute; top:40px; left:0; z-index:1; width:670px; height:240px; background:rgba(0, 0, 0, 0.8); padding:15px; }
	.controls-left { position:absolute; bottom:3px; left:69px; }
	.controls-left a { padding:0px; margin:0px; }
	.controls-left .btn-custom { width:34px; height:34px; line-height:34px; padding:0px; margin:0px; text-align:center; border:0px; border-radius:0px; background:rgba(0, 0, 0, 0.8); color:#fff; }
	.controls-left .btn-custom:focus { box-shadow:none; outline:none; border:none; }
</style>

<div class="title-layer">
	<?php echo apms_widget('brex-shop-gallery-main', $wid.'-wmw8', 'more=3 rows=4 thumb_w=240 thumb_h=210 item=4 md=4 sm=4 xs=4', 'auto=0'); ?>
</div>
...
<!--<div class="controls-left">
	<a href="#<?php echo $widget_id;?>" role="button" data-slide="prev">
		<button class="btn btn-custom"><i class="fa fa-angle-left"></i></button>
	</a>
	<a href="#<?php echo $widget_id;?>" role="button" data-slide="next">
		<button class="btn btn-custom"><i class="fa fa-angle-right"></i></button>
	</a>
</div>-->
