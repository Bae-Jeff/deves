...
<style>
	...
	<?php } else if($is_index) {?>
		.at-body .at-container { padding-top:15px; }
	<?php } else if($gid) {?>
		.at-body .at-container { background:#f6f6f6; }
	<?php } else {?>
	...
	<?php if($is_index || $gid) {?>
		.is-pc .at-body { background:#f6f6f6; }
	<?php } ?>
...
@media all and (max-width:991px) {
	<?php if($bo_table || $gid || $is_index) {?>
		.at-body .at-container { padding:0px !important; }
	<?php } else {?>
		...
		<div class="at-container">
			...
			<div class="header-ad">
				<a href="<?php echo $at_href['change'];?>">
					<img src="<?php echo THEMA_URL;?>/assets/img/ad-pc.jpg">
				</a>
			</div>
			<div class="clearfix"></div>
		</div>
	...
	<header class="m-header">
		<div class="at-container">
			...
			<div class="header-search">
				...
				<input type="hidden" name="url"	value="<?php echo (IS_SHOP) ? $at_href['isearch'] : $at_href['search'];?>">
					<div class="input-group input-group-sm">
						<input type="text" name="stx" class="form-control input-sm" value="<?php echo $stx;?>" placeholder="Search...">
						<span class="input-group-btn">
							<button type="submit" class="btn btn-sm"><i class="fa fa-search fa-lg"></i></button>
						</span>
					</div>
