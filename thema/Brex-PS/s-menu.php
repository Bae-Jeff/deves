	...
	<div class="nav-visible">
		<div class="at-container">
			<div class="nav-top nav-float nav-slide">
				<ul class="menu-ul">
				<li class="menu-li <?php echo (!$gr_id || $gr_id == '') ? 'on' : 'off'; ?>">
					<a class="menu-a nav-height" href="?srows=<?php echo $srows;?>&sfl=<?php echo $sfl;?>&stx=<?php echo $stx;?>&sop=<?php echo $sop;?>">
						통합검색
					</a>
				</li>
				<?php 
				...
				?>
					<li class="menu-li <?php echo $menu[$i]['on'];?>">
						<a class="menu-a nav-height" href="?srows=<?php echo $srows;?>&gr_id=<?php echo $menu[$i]['gr_id'];?>&sfl=<?php echo $sfl;?>&stx=<?php echo $stx;?>&sop=<?php echo $sop;?>"<?php echo $menu[$i]['target'];?>>
